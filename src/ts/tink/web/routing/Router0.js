...
function tink_json_Writer0() {return require("./../../../tink/json/Writer0");}
...
Router0.prototype = {
	...
	hello: function(ctx,name) {
		...
		return (tink_core__$Promise_Promise_$Impl_$().default).next(new (tink_core__$Future_SyncFuture().default)(new (tink_core__$Lazy_LazyConst().default)((tink_core_Outcome().default).Success(d.hello(d1)))),function(__data__) {
			if(ctx.accepts("application/json")) {
				return new (tink_core__$Future_SyncFuture().default)(new (tink_core__$Lazy_LazyConst().default)((tink_core_Outcome().default).Success((tink_web_routing__$Response_Response_$Impl_$().default).textual(200,"application/json",new (tink_json_Writer0().default)().write(__data__),[]))));
			}
			return new (tink_core__$Future_SyncFuture().default)(new (tink_core__$Lazy_LazyConst().default)((tink_core_Outcome().default).Failure(new (tink_core_TypedError().default)(415,"Unsupported Media Type",{ fileName : "src/hx/server/TinkAPI.hx", lineNumber : 21, className : "tink.web.routing.Router0", methodName : "hello"}))));
		});
	}
};
